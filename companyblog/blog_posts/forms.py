...
class BlogPostForm(FlaskForm):
    title = StringField('イベント名',validators=[DataRequired("イベント名を入力してください"),Length(max=50)])
    ...
    organizer = StringField('主催者',validators=[DataRequired("主催者を入力してください"),Length(max=20)])
    place = StringField('場所',validators=[DataRequired("場所を入力してください"),Length(max=20)])
