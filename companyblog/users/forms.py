...
class RegistrationForm(FlaskForm):
    ...
    type = SelectField(u'団体カテゴリを選択してください',choices=[(0, '所属を選択してください'),(2, '(団体)体育会部'),(3, '(団体)文化部'),(4, '任意団体/サークル'),(5, 'ゼミ/その他の団体')],coerce=int, default=0)
...
class UpdateUserForm(FlaskForm):
    ...
    university = SelectField(u'大学を選択してください',choices=[(1, '駒澤大学')],coerce=int, default=0)
    type = SelectField(u'団体カテゴリを選択してください',choices=[(0, '所属を選択してください。'),(2, '(団体)体育会部'),(3, '(団体)文化部'),(4, '任意団体/サークル'),(5, 'ゼミ/その他の団体')],coerce=int)
